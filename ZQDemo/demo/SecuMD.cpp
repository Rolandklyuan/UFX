    ...
    if (lpMsg!=NULL)
    {
        ...
        if (lpMsg->GetReturnCode() ==0)
        {
            ...
            switch(lpMsg->GetFunction())
            {
                ...
                case 333002:
                    //ShowPacket(lpUnPacker);
                    cout<<"entrust_no:"<<lpUnPacker->GetInt("entrust_on")<<";"<<"entrust_time:"<<lpUnPacker->GetStr("entrust_time");
                    lpUnPacker->AddRef();
                    lpUnPacker->Release();
                    cout<<"等待回报....."<<endl;
                    break;
                ...
                case MSGCENTER_FUNC_REG:
                    ...
                    {puts(lpUnPacker_key->GetStr("error_info"));
                        ...
                        puts("订阅成功...");
                    cout<<"SequeceNo:"<<lpMsg->GetSequeceNo()<<endl;
                ...
                case MSGCENTER_FUNC_SENDED:
                    {   
                        ...
                        int SequeceNo=lpMsg->GetSequeceNo();
                        cout<<"SequeceNo:"<<SequeceNo<<endl;
